...
<head>
    ...
    <style type="text/css">
        ...
        .analytics a:hover {
            color: #FFFFFF;
            background-image: url("/images/analyticbg.png");
        !important;
        }
        ...
        .retailer a:focus {
            color: #FFFFFF;
            background-image: url("/images/retailerbg.png");
        !important;
        }
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
        ...
        <div class="container">
            ...
            <a class="navbar-brand font-weight-bold" href="/dashboard/analytics">
                <img src="/images/logos.png" alt="logo" width="65%">
            </a>
                ...
                <ul class="navbar-nav ml-auto text-white">
                    ...
                    <li class="nav-item mr-3" style="width: 40px;">
                        <a href="#" class="nav-link nav-icon iconClass" style="margin: 22px">
                            <img src="/images/bell.png" alt="bell" width="25" height="25">
                            <span class="badge badge-light">2</span>
                        </a>
                    </li>
                    <div class="dropdown show">
                        <a class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="/images/admin.png" alt="logo" width="50%">
                        </a>
            ...
            <div class="col-md-2 col-sm-3 m-1">
                <div class="card justify-content-center mt-2 mb-2">
                    ...
                    <div class="card-header text-center text-white font-weight-bold" style="background-color: #00BCF9">
                        <p class="retailer-text">New Retailers</p>
                    </div>
                    ...
                    <div class="p-1">
                        <div class="bg-white rounded-lg pt-2 pb-2">
                            ...
                            <div class="progress mx-auto" data-value='100'>
                                ...
                                <div class="progress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                                    <div class="h2 font-weight-bold" style="color: #E58821">{{ $total_vip }} || 45</div>
                                </div>
                            </div>
                        </div>
                    </div>
